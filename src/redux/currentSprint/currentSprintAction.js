...
const getCurrentSprintRequest = createAction("currentSprint/getCurrentSprintRequest");
const getCurrentSprintSuccess = createAction("currentSprint/getCurrentSprintSuccess");
const getCurrentSprintError = createAction("currentSprint/getCurrentSprintError");
...
const changeTaskNameRequest = createAction("currentSprint/changeTaskNameRequest");
const changeTaskNameSuccess = createAction("currentSprint/changeTaskNameSuccess");
const changeTaskNameError = createAction("currentSprint/changeTaskNameError");

const updateTaskTimeRequest = createAction("currentSprint/updateTaskTimeRequest");
const updateTaskTimeSuccess = createAction("currentSprint/updateTaskTimeSuccess");
