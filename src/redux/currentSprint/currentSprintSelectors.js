...
export const resultTaskArray = createSelector([currentTasksSelector, search], (tasks, searchQuery) => {
    // console.log(search);

    return tasks ? tasks.filter(item => item.name.toLowerCase().includes(searchQuery.toLowerCase())) : [];
})